 ...
 */
class JiwenTemplate extends Template
{
    static protected $defaultOptions = array(
        'previous_message'   => '<p class="prev">上一页</p>',
        'next_message'       => '<p class="next">下一页</p>',
        'css_disabled_class' => 'disabled',
        'css_dots_class'     => 'dots',
        'css_current_class'  => 'current',
        'dots_text'          => '...',
        'container_template' => '<div>%pages%</div>',
        'page_template'      => '<a class="item" href="%href%">%text%</a>',
        'span_template'      => '<span class="%class% item">%text%</span>'
    );
