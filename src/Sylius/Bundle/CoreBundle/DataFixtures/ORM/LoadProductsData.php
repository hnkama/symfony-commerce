...
class LoadProductsData extends DataFixture
{
    ...
    private function createTShirt($i)
    {
        ...
        $this->setTaxons($product, array('圣诗服', 'SuperTees'));
    ...
    private function createSticker($i)
    {
        ...
        $this->setTaxons($product, array('桌 椅', 'Stickypicky'));
    ...
    private function createMug($i)
    {
        ...
        $this->setTaxons($product, array('祷告垫', 'Mugland'));
    ...
    private function createBook($i)
    {
        ...
        $this->setTaxons($product, array('图书音像', 'Bookmania'));
